...
MySQL - 5.6.17 : Database - news_cms
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`news_cms` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `cms_admin`(`admin_id`,`username`,`password`,`lastloginip`,`lastlogintime`,`email`,`realname`,`status`) values (2,'wang','ea9d264a7f7ac8bbbb6cadb71987cdc8','0',1495693020,'','王',1),(1,'admin','24e7a730ff315b8bb4f013a282b98ebd','0',1495692660,'email','三',1);
...
insert  into `cms_menu`(`menu_id`,`name`,`parentid`,`m`,`c`,`f`,`listorder`,`status`,`type`,`data`) values (1,'菜单管理',0,'admin','menu','index',10,1,1,''),(2,'文章管理',0,'admin','Content','index',0,-1,1,''),(3,'体育',0,'home','cat','index',3,1,0,''),(4,'科技',0,'home','cat ','index',0,-1,0,''),(5,'汽车',0,'home','cat','index',0,-1,0,''),(6,'文章管理',0,'admin','content','index',9,1,1,''),(7,'用户管理',0,'admin','user','index',0,-1,1,''),(8,'科技',0,'home','cat','index',0,1,0,''),(9,'推荐位管理',0,'admin','position','index',4,1,1,''),(10,'推荐位内容管理',0,'admin','positioncontent','index',1,1,1,''),(11,'基本管理',0,'admin','basic','index',0,1,1,''),(12,'新闻',0,'home','cat','index',0,1,0,''),(13,'用户管理',0,'admin','admin','index',0,1,1,'');
...
CREATE TABLE `cms_news` (
  ...
  `posids` smallint(5) DEFAULT NULL,
...
insert  into `cms_news`(`news_id`,`catid`,`title`,`small_title`,`title_font_color`,`thumb`,`keywords`,`description`,`listorder`,`status`,`copyfrom`,`username`,`create_time`,`update_time`,`posids`,`count`) values (17,3,'test','test','#5674ed','/upload/2016/03/06/56dbdc0c483af.JPG','sss','sss',1,-1,'0','admin',1455756856,0,0,0),(18,3,'你好ssss','你好','#ed568b','/upload/2016/03/06/56dbdc015e662.JPG','你好','你好sssss  ss',2,-1,'3','admin',1455756999,0,0,0),(19,8,'1','11','#5674ed','/upload/2016/02/28/56d312b12ccec.png','1','1',0,-1,'0','admin',1456673467,0,0,0),(20,3,'事实上','11','','/upload/2016/02/28/56d3185781237.png','1','11',0,-1,'0','admin',1456674909,0,0,0),(21,3,'习近平今日下午出席解放军代表团全体会议','习近平出席解放军代表团全体会议','','/upload/2016/03/13/56e519a185c93.png','中共中央总书记 国家主席 中央军委主席 习近平','中共中央总书记',0,1,'1','admin',1457854896,0,0,16),(22,12,'李克强让部长们当第一新闻发言人','李克强让部长们当第一新闻发言人','','/upload/2016/03/13/56e51b6ac8ce2.jpg','李克强  新闻发言人','部长直接面对媒体回应关切，还能直接读到民情民生民意，而不是看别人的舆情汇报。',0,1,'0','admin',1457855362,0,0,19),(23,3,'重庆美女球迷争芳斗艳','重庆美女球迷争芳斗艳','','/upload/2016/03/13/56e51cbd34470.png','重庆美女 球迷 争芳斗艳','重庆美女球迷争芳斗艳',1,1,'0','admin',1457855680,0,0,4),(24,3,'中超-汪嵩世界波制胜 富力客场1-0力擒泰达','中超-汪嵩世界波制胜 富力客场1-0力擒泰达','','/upload/2016/03/13/56e51fc82b13a.png','中超 汪嵩世界波  富力客场 1-0力擒泰达','中超-汪嵩世界波制胜 富力客场1-0力擒泰达',0,1,'0','admin',1457856460,0,0,16);
...
CREATE TABLE `cms_position_content` (
  ...
  `news_id` mediumint(8) unsigned NOT NULL,
  `listorder` tinyint(3) NOT NULL DEFAULT '1',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
insert  into `cms_position_content`(`id`,`position_id`,`title`,`thumb`,`url`,`news_id`,`listorder`,`status`,`create_time`,`update_time`) values (28,2,'习近平今日下午出席解放军代表团全体会议','/upload/2016/03/13/56e519a185c93.png',NULL,21,0,1,1457854896,0),(27,2,'文章18测试sss','/upload/2016/03/07/56dcc0158f70e.JPG','',18,0,-1,1457306930,0),(26,2,'ss','/upload/2016/03/07/56dcbce02cab9.JPG','http://sina.com.cn',0,0,-1,1457306890,0),(25,3,'test','/upload/2016/03/06/56dbdc0c483af.JPG',NULL,17,0,-1,1455756856,0),(23,2,'test','/upload/2016/03/06/56dbdc0c483af.JPG',NULL,17,1,-1,1455756856,0),(24,2,'你好ssss','/upload/2016/03/06/56dbdc015e662.JPG',NULL,18,2,-1,1455756999,0),(29,3,'李克强让部长们当第一新闻发言人','/upload/2016/03/13/56e51b6ac8ce2.jpg',NULL,22,12,1,1457855362,0),(30,3,'重庆美女球迷争芳斗艳','/upload/2016/03/13/56e51cbd34470.png',NULL,23,0,1,1457855680,0),(31,3,'中超-汪嵩世界波制胜 富力客场1-0力擒泰达','/upload/2016/03/13/56e51fc82b13a.png',NULL,24,0,1,1457856460,0),(32,5,'2015劳伦斯国际体坛精彩瞬间','/upload/2016/03/13/56e5612d525c3.png','http://sports.sina.com.cn/laureus/moment2015/',0,0,1,1457873220,0);

/*Table structure for table `cms_reader` */

DROP TABLE IF EXISTS `cms_reader`;

CREATE TABLE `cms_reader` (
  `reader_id` mediumint(6) NOT NULL AUTO_INCREMENT,
  `readername` varchar(20) CHARACTER SET latin1 NOT NULL,
  `create_time` int(11) NOT NULL,
  `readerpwd` varchar(32) CHARACTER SET latin1 NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `lasttime` int(11) DEFAULT NULL,
  PRIMARY KEY (`reader_id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `cms_reader` */

insert  into `cms_reader`(`reader_id`,`readername`,`create_time`,`readerpwd`,`status`,`lasttime`) values (1,'user',0,'a4f5a340d0caa8a4e0992838d51ef3d3',0,NULL),(2,'zhou',0,'fb1121c40412c660673bf3c477b4f3b7',1,NULL),(3,'ss',0,'5c1464330ea854099a881af71ba4e9a3',1,NULL),(4,'wang',0,'ea9d264a7f7ac8bbbb6cadb71987cdc8',1,1495693750);

/*Table structure for table `cms_tc` */

DROP TABLE IF EXISTS `cms_tc`;

CREATE TABLE `cms_tc` (
  `tc_id` mediumint(6) NOT NULL,
  `reader_id` mediumint(6) NOT NULL,
  `news_id` varchar(20) NOT NULL,
  `create_time` int(11) NOT NULL,
  `tc_content` varchar(200) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cms_tc` */

insert  into `cms_tc`(`tc_id`,`reader_id`,`news_id`,`create_time`,`tc_content`) values (0,4,'24',1495694967,'哈哈哈');
