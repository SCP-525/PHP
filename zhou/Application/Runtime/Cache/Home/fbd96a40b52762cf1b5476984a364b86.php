			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					...
					<div class="form-group">
						...
						<!--<h1><?php echo ($name); ?></h1>-->
						<div class="col-sm-5">
							<input type="text" class="form-control" name="reader_email" id="inputPassword3" placeholder="" value="<?php echo ($email["reader_email"]); ?>">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="button" class="btn btn-default" id="button-submit" onclick="reader.save()">提交</button>
						</div>
					</div>
				</form>
